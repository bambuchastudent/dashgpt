...
- User action required now: **confirm OpenAI Platform publisher access + verified identity**.
...
1. Confirm the OpenAI Platform publishing organization has a submitter with Apps Management write access and a verified developer/business identity.
2. Create **DashGPT** in the OpenAI Platform plugin submission flow using the production Universal MCP URL.
3. Complete domain verification using the portal challenge token.
4. Scan tools and fill listing, starter prompts, reviewer tests, availability and release notes from `plugins/dashgpt/SUBMISSION.md`.
5. Submit for OpenAI review.
...
- OpenAI Platform Apps Management write access and publisher identity verification are not yet confirmed.
