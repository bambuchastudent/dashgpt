...
2. Read `docs/development-summary.md` — how we are building it.
3. Read `docs/roadmap.md` — current milestone and ordering.
4. Read the active OpenSpec change/spec for the task.
5. Inspect the actual repository before proposing code changes.
